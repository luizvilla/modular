 ...
 * To customize webpack configuration change /home/luiz-villa/code/modular/theia/applications/electron/webpack.config.js
 */
// @ts-check
...
const nativePlugin = new NativeWebpackPlugin({
    out: 'native',
    trash: true,
    ripgrep: false, /* disabled: @vscode/ripgrep 1.18.0 moved bin to platform packages, incompatible with this plugin */
    pty: true,
    nativeBindings: {
