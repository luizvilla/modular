...
var freeboard = (function()
{
	...
	{
		return typeName === "owntech_plot_uplot" || typeName === "xy_plot_uplot" || typeName === "fast_frame_plot" || typeName === "vertical_gauge" || typeName === "horizontal_gauge" || typeName === "radial_arc_gauge" || typeName === "radial_needle_gauge" || typeName === "donut_gauge";
	}
