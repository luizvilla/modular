...
## What it does
Single-channel horizontal gauge with integrated source binding, warning and critical zones, and optional alarm state.
...
- Style: Configure palette, active color, compact mode, value label placement, and fill direction.

## Usage (in dashboard)
- Horizontal track: Shows the current value across the configured range.
