...
## What it does
Single-channel donut gauge with integrated source binding, warning and critical zones, and optional alarm state.
...
- Style: Configure palette, active color, ring thickness, and center value size.

## Usage (in dashboard)
- Donut ring: Shows the current value across the configured range.
