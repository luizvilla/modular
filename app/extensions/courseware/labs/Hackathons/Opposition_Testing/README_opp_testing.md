# Opposition testing Hackathon

This hackathon focuses on using the Modular dashboard in `../modular` to create an opposition test. Modular is a local desktop app for real-time instrumentation and device control: connect the hardware, stream data, visualize behavior, and interact with the firmware from the dashboard.


## First iteration: using the board as a buck converter
...
![Communication setup](Image/wiring_diagram.drawio.png)
